...
{
    public class MySqlAgileDataProvider : BaseDataProvider, IAgileDataProvider
    {
        #region Fields
        ...
        protected void ExecuteSqlScriptFromFile(IAgileFileProvider fileProvider, string filePath)
        {
        ...
        public void InitializeDatabase()
        {
            ...
            ExecuteSqlScriptFromFile(fileProvider, AgileDataDefaults.MySQLStoredProceduresFilePath);
        }
        ...
        public virtual string BuildConnectionString(IAgileConnectionStringInfo nopConnectionString)
        {
            if (nopConnectionString is null)
                throw new ArgumentNullException(nameof(nopConnectionString));

            if (nopConnectionString.IntegratedSecurity)
                throw new AgileException("Data provider supports connection only with login and password");
