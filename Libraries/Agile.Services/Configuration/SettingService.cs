...
using Agile.Core.Caching.CachingDefaults;
using Agile.Core.Configuration;
using Agile.Data;
using Agile.Services.Caching.Extensions;
...
namespace Agile.Services.Configuration
{
    public partial class SettingService : ISettingService
    {
        ...
        {
            //cache
            return _cacheManager.Get(AgileConfigurationCachingDefaults.SettingsAllAsDictionaryCacheKey, () =>
            {
        ...
        public virtual IList<Setting> GetAllSettings()
        {
            ...
            var settings = query.ToCachedList(AgileConfigurationCachingDefaults.SettingsAllCacheKey);
        ...
        {
            _cacheManager.RemoveByPrefix(AgileConfigurationCachingDefaults.SettingsPrefixCacheKey);
        }
